  ...
  async function renderForm(outlet) {
      ...
      <form id="article-form" style="display:flex;flex-direction:column;gap:16px;max-width:880px">
        ...
        <div class="card">
          ...
          <div class="form-grid-2">
            ...
            <label class="field"><span>Ingrediënten (NL)</span><textarea name="ingredients_nl" rows="6" placeholder="Brood (TARWE...), ...">${escapeHtml(article.ingredients_nl)}</textarea></label>
          </div>
        </div>
        ...
        <div class="card">
          ...
          <div class="form-grid-2">
            ...
            <label class="field"><span>Allergenen (NL)</span><textarea name="allergenes_nl" rows="2">${escapeHtml(article.allergenes_nl)}</textarea></label>
          </div>
        </div>
    ...
    outlet.querySelector("#article-form").addEventListener("submit", async (e) => {
      ...
      const updated = {
        ...
        nom_nl: fd.get("nom_nl").trim(),
        sous_titre_fr: fd.get("sous_titre_fr").trim(),
        sous_titre_nl: fd.get("sous_titre_nl").trim(),
        ...
        ingredients_nl: fd.get("ingredients_nl").trim(),
        allergenes_fr: fd.get("allergenes_fr").trim(),
        allergenes_nl: fd.get("allergenes_nl").trim(),
